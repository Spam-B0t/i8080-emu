...
int disassemble8080(unsigned char *buffer, int pc){
    ...
    switch(*code){
        ...
        case 0x06: printf("MVI  B,#$%02x", code[1]); byte=2; break;
        ...
        case 0x0e: printf("MVI  C,#$%02x", code[1]); byte=2; break;
        ...
        case 0x16: printf("MVI  D,#$%02x", code[1]); byte=2; break;
        ...
        case 0x1e: printf("MVI  E,#$%02x", code[1]); byte=2; break;
        ...
        case 0x26: printf("MVI  H,#$%02x", code[1]); byte=2; break;
        ...
        case 0x2e: printf("MVI  L,#$%02x", code[1]); byte=2; break;
        ...
        case 0x36: printf("MVI  M,#$%02x", code[1]); byte=2; break;
        ...
        case 0x3e: printf("MVI  A,#$%02x", code[1]); byte=2; break;
        ...
        case 0xc6: printf("ADI  #$%02x", code[1]); byte=2; break;
        ...
        case 0xe6: printf("ANI  #$%02x", code[1]); byte=2; break;
        ...
        case 0xee: printf("XRI  #$%02x", code[1]); byte=2; break;
        ...
        case 0xf6: printf("ORI  #$%02x", code[1]); byte=2; break;
        ...
        case 0xfe: printf("CPI  #$%02x", code[1]); byte=2; break;
...
int main() { //printf("%d %d\n", 0x00, 0xff);
    ...
    if(f){
        ...
        /*int i;
        for(i=0;i<fsize;i++){
            if(i%16==0)printf("%d0 ", i/16);
            //if(data[i]<=0xf)printf("0%x ", data[i]);
            //else printf("%x ", data[i]);
            printf("%02x ", data[i]);
            if((i+1)%16==0)printf("\n");
        }*/
        while(pc<fsize)pc+=disassemble8080(&data[0], pc);
    }
